...
public:
	...
	struct FScriptDelegate                             __EventAdHocOnNetworkChanged__Delegate;                   // 0x0040(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAdHocError__Delegate;                              // 0x0050(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAdHocInitialized__Delegate;                        // 0x0060(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAccessPointCreated__Delegate;                      // 0x0070(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventBecomeStation__Delegate;                           // 0x0080(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventStationConnected__Delegate;                        // 0x0090(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventStationDisconnected__Delegate;                     // 0x00A0(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAdHocFinalized__Delegate;                          // 0x00B0(0x0010) (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAdHocDestroyed__Delegate;                          // 0x00C0(0x0010) (CPF_NeedCtorLink)
