...
struct UOnlineAuthInterfaceImpl_RequiresMTXAuthorizationCode_Params
{
	bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ReturnParm)
};

// Function IpDrv.OnlineAuthInterfaceImpl.RequiresAuthorizationCode
struct UOnlineAuthInterfaceImpl_RequiresAuthorizationCode_Params
{
	bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ReturnParm)
};

// Function IpDrv.OnlineAuthInterfaceImpl.IsRequestingAuthorizationCode
struct UOnlineAuthInterfaceImpl_IsRequestingAuthorizationCode_Params
{
	struct FUniqueNetId                                PlayerID;                                                 // (CPF_Parm)
...
struct UOnlineAuthInterfaceImpl_RequestAuthorizationCode_Params
{
	struct FUniqueNetId                                PlayerID;                                                 // (CPF_Parm)
	struct FScriptDelegate                             Callback;                                                 // (CPF_Parm, CPF_NeedCtorLink)
	bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ReturnParm)
...
struct UOnlineAuthInterfaceImpl_OnReceivedAuthorizationCode_Params
{
	bool                                               bSuccess;                                                 // (CPF_Parm)
