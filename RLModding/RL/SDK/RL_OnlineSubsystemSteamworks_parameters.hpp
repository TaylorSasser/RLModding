...
struct UOnlineAuthInterfaceSteamworks_RequiresMTXAuthorizationCode_Params
{
	bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ReturnParm)
};

// Function OnlineSubsystemSteamworks.OnlineAuthInterfaceSteamworks.RequiresAuthorizationCode
struct UOnlineAuthInterfaceSteamworks_RequiresAuthorizationCode_Params
{
	bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ReturnParm)
};

// Function OnlineSubsystemSteamworks.OnlineAuthInterfaceSteamworks.IsRequestingAuthorizationCode
struct UOnlineAuthInterfaceSteamworks_IsRequestingAuthorizationCode_Params
{
...
struct UOnlineAuthInterfaceSteamworks_RequestAuthorizationCode_Params
{
	struct FUniqueNetId                                PlayerID;                                                 // (CPF_Parm)
	struct FScriptDelegate                             Callback;                                                 // (CPF_Parm, CPF_NeedCtorLink)
	bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ReturnParm)
...
struct UOnlineLobbyInterfaceSteamworks_SendLobbyMessage_Params
{
	struct FUniqueLobbyId                              LobbyId;                                                  // (CPF_Const, CPF_Parm, CPF_OutParm)
