...
enum class EFeaturePrivilegeLevel
{
	FPL_Disabled                   = 0,
	FPL_Premium                    = 1,
...
enum class EOnlineServerConnectionStatus
{
	OSCS_NotConnected              = 0,
	OSCS_Connected                 = 1,
...
enum class ESessionMemberStatus
{
	DSMS_Reserved                  = 0,
	DSMS_Inactive                  = 1,
	DSMS_Ready                     = 2,
...
enum class EInventoryItemState
{
	IIS_Unknown                    = 0,
	IIS_All                        = 1,
	IIS_Enabled                    = 2,
...
enum class EOnlineEnumerationReadState
{
	OERS_NotStarted                = 0,
	OERS_InProgress                = 1,
	OERS_Done                      = 2,
...
enum class EAchievementUnlockType
{
	AUT_Unknown                    = 0,
	AUT_All                        = 1,
	AUT_Persistent                 = 2,
...
enum class EAchievementMediaAssetType
{
	AMAT_Unknown                   = 0,
	AMAT_Icon                      = 1,
	AMAT_Art                       = 2,
...
enum class EAchievementParticipationType
{
	APT_Unknown                    = 0,
	APT_Individual                 = 1,
	APT_Group                      = 2,
...
enum class EAchievementProgressState
{
	APS_Unknown                    = 0,
	APS_Achieved                   = 1,
	APS_NotStarted                 = 2,
...
enum class EAchievementRewardType
{
	ART_Unknown                    = 0,
	ART_Gamerscore                 = 1,
	ART_InApp                      = 2,
...
enum class EOnlineDataAdvertisementType
{
...
enum class EOnlineAccountCreateStatus
{
...
enum class EOnlineCreateGameSessionFlag
{
	OCGSF_New                      = 0,
	OCGSF_ReSubmit                 = 1,
	OCGSF_MAX                      = 2
...
enum class ENetworkNotificationPosition
{
	NNP_TopLeft                    = 0,
	NNP_TopCenter                  = 1,
	NNP_TopRight                   = 2,
...
enum class EPropertyValueMappingType
{
	PVMT_RawValue                  = 0,
...
enum class ERBCollisionChannel
{
	RBCC_Default                   = 0,
	RBCC_Nothing                   = 1,
	RBCC_Pawn                      = 2,
...
enum class EOnlineGameSearchComparisonType
{
	OGSCT_Equals                   = 0,
	OGSCT_NotEquals                = 1,
	OGSCT_GreaterThan              = 2,
...
enum class EOnlineGameSearchEntryType
{
	OGSET_Property                 = 0,
...
enum class EOnlineGameSearchSortType
{
	OGSSO_Ascending                = 0,
	OGSSO_Descending               = 1,
	OGSSO_MAX                      = 2
...
enum class EProgressMessageType
{
	PMT_Clear                      = 0,
	PMT_Information                = 1,
	PMT_AdminMessage               = 2,
...
enum class EInstanceWeightUsage
{
	IWU_PartialSwap                = 0,
	IWU_FullSwap                   = 1,
	IWU_MAX                        = 2
...
enum class ERootMotionRotationMode
{
	RMRM_Ignore                    = 0,
	RMRM_RotateActor               = 1,
	RMRM_MAX                       = 2
...
enum class EMaxDistanceScaleMode
{
	MDSM_Multiply                  = 0,
	MDSM_Substract                 = 1,
	MDSM_MAX                       = 2
...
enum class EAmbientOcclusionQuality
{
	AO_High                        = 0,
	AO_Medium                      = 1,
	AO_Low                         = 2,
...
enum class ERootRotationOption
{
	RRO_Default                    = 0,
	RRO_Discard                    = 1,
	RRO_Extract                    = 2,
...
enum class EMobileTextureBlendFactorSource
{
	MTBFS_VertexColor              = 0,
	MTBFS_MaskTexture              = 1,
	MTBFS_MAX                      = 2
...
enum class EMobileTexCoordsSource
{
	MTCS_TexCoords0                = 0,
	MTCS_TexCoords1                = 1,
	MTCS_TexCoords2                = 2,
...
enum class EMobileAlphaValueSource
{
...
enum class EMobileColorMultiplySource
{
	MCMS_None                      = 0,
...
enum class EMobileEmissiveColorSource
{
...
enum class EMobileEnvironmentBlendMode
{
	MEBM_Add                       = 0,
	MEBM_Lerp                      = 1,
	MEBM_MAX                       = 2
...
enum class EMobileAmbientOcclusionSource
{
	MAOS_Disabled                  = 0,
...
enum class EDynamicLightEnvironmentBoundsMethod
{
...
enum class EDamageParameterOverrideMode
{
	DPOM_Absolute                  = 0,
	DPOM_Multiplier                = 1,
	DPOM_MAX                       = 2
...
enum class ESaveDataVersionSupport
{
...
enum class ESaveSlotOperationEnum
{
	SSO_SET                        = 0,
	SSO_GET                        = 1,
	SSO_DELETE                     = 2,
...
enum class ECoverGroupFillAction
{
	CGFA_Overwrite                 = 0,
	CGFA_Add                       = 1,
	CGFA_Remove                    = 2,
...
enum class ECoverLocationDescription
{
	CoverDesc_None                 = 0,
...
enum class ELightmapModificationFunction
{
	MLMF_Modulate                  = 0,
...
enum class EShadowFilterQuality
{
	SFQ_Low                        = 0,
	SFQ_Medium                     = 1,
	SFQ_High                       = 2,
...
enum class EShadowProjectionTechnique
{
...
enum class ELightAffectsClassification
{
	LAC_USER_SELECTED              = 0,
...
enum class EFacebookIntegrationDelegate
{
...
enum class EHostMigrationProgress
{
...
// Enum Engine.WorldInfo.EPitchTekTargetSize
enum class EPitchTekTargetSize
{
	PTTS                           = 0,
	PTTS01                         = 1,
	PTTS02                         = 2,
...
enum class EPreferredLightmapType
{
	EPLT_Default                   = 0,
	EPLT_Directional               = 1,
	EPLT_Simple                    = 2,
...
enum class EInAppMessageInterfaceDelegate
{
...
enum class EEdgeHandlingStatus
{
	EHS_AddedBothDirs              = 0,
	EHS_Added0to1                  = 1,
	EHS_Added1to0                  = 2,
...
enum class EHeadTrackingAction
{
...
enum class EInterpTrackMoveFrame
{
	IMF_World                      = 0,
...
enum class ELevelGridCellShape
{
	LGCS_Box                       = 0,
	LGCS_Hex                       = 1,
	LGCS_MAX                       = 2
...
enum class EMaterialPositionTransform
{
...
enum class EFFG_ForceFieldCoordinates
{
	FFG_CARTESIAN                  = 0,
	FFG_SPHERICAL                  = 1,
	FFG_CYLINDRICAL                = 2,
...
enum class EFFB_ForceFieldCoordinates
{
	FFB_CARTESIAN                  = 0,
	FFB_SPHERICAL                  = 1,
	FFB_CYLINDRICAL                = 2,
...
enum class ELobbyKickReason
{
	...
	LKR_InGame                     = 4,
	LKR_LeaveAction                = 5,
	LKR_OwnerDisappeared           = 6,
	LKR_ConnectionError            = 7,
	LKR_SignedOut                  = 8,
	LKR_MAX                        = 9
};
...
enum class EOnlineProfilePropertyOwner
{
	OPPO_None                      = 0,
...
enum class EOnlinePlayerStorageAsyncState
{
	OPAS_NotStarted                = 0,
	OPAS_Read                      = 1,
	OPAS_Write                     = 2,
...
enum class EProfileDifficultyOptions
{
	PDO_Normal                     = 0,
	PDO_Easy                       = 1,
	PDO_Hard                       = 2,
...
enum class EProfileControllerSensitivityOptions
{
	PCSO_Medium                    = 0,
	PCSO_Low                       = 1,
	PCSO_High                      = 2,
...
enum class EProfilePreferredColorOptions
{
	PPCO_None                      = 0,
	PPCO_Black                     = 1,
	PPCO_White                     = 2,
...
enum class EProfileAutoAimOptions
{
	PAAO_Off                       = 0,
	PAAO_On                        = 1,
	PAAO_MAX                       = 2
...
enum class EProfileAutoCenterOptions
{
	PACO_Off                       = 0,
	PACO_On                        = 1,
	PACO_MAX                       = 2
...
enum class EProfileMovementControlOptions
{
	PMCO_L_Thumbstick              = 0,
	PMCO_R_Thumbstick              = 1,
	PMCO_MAX                       = 2
...
enum class EProfileRaceTransmissionOptions
{
	PRTO_Auto                      = 0,
	PRTO_Manual                    = 1,
	PRTO_MAX                       = 2
...
enum class EProfileRaceCameraLocationOptions
{
	PRCLO_Behind                   = 0,
	PRCLO_Front                    = 1,
	PRCLO_Inside                   = 2,
...
enum class EProfileRaceBrakeControlOptions
{
	PRBCO_Trigger                  = 0,
	PRBCO_Button                   = 1,
	PRBCO_MAX                      = 2
...
enum class EProfileRaceAcceleratorControlOptions
{
	PRACO_Trigger                  = 0,
	PRACO_Button                   = 1,
	PRACO_MAX                      = 2
...
enum class EProfileYInversionOptions
{
	PYIO_Off                       = 0,
	PYIO_On                        = 1,
	PYIO_MAX                       = 2
...
enum class EProfileXInversionOptions
{
	PXIO_Off                       = 0,
	PXIO_On                        = 1,
	PXIO_MAX                       = 2
...
enum class EProfileOmniDirEvadeOptions
{
	PODI_Off                       = 0,
	PODI_On                        = 1,
	PODI_MAX                       = 2
...
enum class EProfileControllerVibrationToggleOptions
{
	PCVTO_Off                      = 0,
	PCVTO_IgnoreThis               = 1,
	PCVTO_IgnoreThis2              = 2,
...
enum class EProfileVoiceThruSpeakersOptions
{
	PVTSO_Off                      = 0,
	PVTSO_On                       = 1,
	PVTSO_Both                     = 2,
...
enum class EBoneSocketAttractorFalloffType
{
	BSFOFF_Constant                = 0,
	BSFOFF_Linear                  = 1,
	BSFOFF_Exponent                = 2,
...
enum class ELocationBoneSocketDestSelectionMethod
{
...
enum class ELocationBoneSocketDestination
{
...
enum class EVertSurfaceAttractorFalloffType
{
	VSFOFF_Constant                = 0,
	VSFOFF_Linear                  = 1,
	VSFOFF_Exponent                = 2,
...
enum class EAttractorSkelVertSurfaceDestination
{
...
enum class EParticleAttractorActionType
{
	PAAT_None                      = 0,
	PAAT_Destroy                   = 1,
	PAAT_Freeze                    = 2,
...
enum class ELocationStaticVertSurfaceSource
{
...
enum class EParticleLevelInfluenceType
{
	LIT_Never                      = 0,
...
enum class EBeamEndPointMethod
{
	PEBEPM_Calculated              = 0,
...
enum class EPhysXMeshRotationMethod
{
	PMRM_Disabled                  = 0,
	PMRM_Spherical                 = 1,
	PMRM_Box                       = 2,
...
enum class EBuildingStatsBrowserColumns
{
	BSBC_Name                      = 0,
	BSBC_Ruleset                   = 1,
...
enum class EPacketSizeMultiplier
{
	EPSM                           = 0,
	EPSM01                         = 1,
	EPSM02                         = 2,
...
enum class ESceneCaptureViewMode
{
	SceneCapView_Lit               = 0,
...
enum class EWorldAttractorFalloffType
{
	FOFF_Constant                  = 0,
	FOFF_Linear                    = 1,
	FOFF_Exponent                  = 2,
...
enum class EParticleEventOutputType
{
...
enum class ESplineControlRotMode
{
	SCR_NoChange                   = 0,
	SCR_AlongSpline                = 1,
	SCR_Interpolate                = 2,
...
enum class ESkeletalMeshOptimizationNormalMode
{
	SMONM_Recalculate              = 0,
...
enum class EClothMovementScaleGen
{
...
enum class ETerrainMappingType
{
	TMT_Auto                       = 0,
	TMT_XY                         = 1,
	TMT_XZ                         = 2,
...
enum class ETextureFlipBookMethod
{
	TFBM_UL_ROW                    = 0,
	TFBM_UL_COL                    = 1,
	TFBM_UR_ROW                    = 2,
...
enum class EPitchTekTextureType
{
...
enum class EGameShaderParameterType
{
...
{
	TEnumAsByte<EPitchTekTargetSize>                   ColorTargetSize;                                          // 0x0000(0x0001) (CPF_Edit)
	TEnumAsByte<EPitchTekTargetSize>                   DataTargetSize;                                           // 0x0001(0x0001) (CPF_Edit)
...
struct FNetworkEncryptionKey
{
	...
	unsigned long                                      InUse : 1;                                                // 0x007C(0x0004)
	struct FDouble                                     TimeLastUsed;                                             // 0x0080(0x0008)
};
...
struct FOnlineFriend
{
	...
	struct FString                                     PlayerName;                                               // 0x0050(0x000C) (CPF_Const, CPF_NeedCtorLink)
	struct FString                                     PresenceInfo;                                             // 0x005C(0x000C) (CPF_Const, CPF_NeedCtorLink)
	TEnumAsByte<EOnlineFriendState>                    FriendState;                                              // 0x0068(0x0001) (CPF_Const)
	unsigned long                                      bIsOnline : 1;                                            // 0x006C(0x0004) (CPF_Const)
	unsigned long                                      bIsPlaying : 1;                                           // 0x006C(0x0004) (CPF_Const)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x006C(0x0004) (CPF_Const)
	unsigned long                                      bIsJoinable : 1;                                          // 0x006C(0x0004) (CPF_Const)
	unsigned long                                      bHasVoiceSupport : 1;                                     // 0x006C(0x0004) (CPF_Const)
	unsigned long                                      bHaveInvited : 1;                                         // 0x006C(0x0004)
	unsigned long                                      bHasInvitedYou : 1;                                       // 0x006C(0x0004) (CPF_Const)
	int                                                GroupId;                                                  // 0x0070(0x0004) (CPF_Const)
	unsigned long                                      bIsBlocked : 1;                                           // 0x0074(0x0004) (CPF_Const)
};
...
struct FUIDataStoreInputAlias
{
	...
	struct FUIInputKeyData                             PlatformInputKeys[0x6];                                   // 0x0008(0x0018) (CPF_Config, CPF_NeedCtorLink)
};
